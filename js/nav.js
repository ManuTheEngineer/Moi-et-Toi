...
window.addEventListener('resize', function () {
  ...
  _navResizeTimer = requestAnimationFrame(function () {
    updateNavIndicator();
    _navResizeTimer = 0;
  });
});
...
const _IC = {
  ...
  game: _i(
    '<rect x="2" y="6" width="20" height="12" rx="2"/><line x1="6" y1="12" x2="10" y2="12"/><line x1="8" y1="10" x2="8" y2="14"/><circle cx="16" cy="11" r=".5" fill="currentColor"/><circle cx="18" cy="13" r=".5" fill="currentColor"/>'
  ),
  chat: _i('<path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/>'),
  wave: _i(
    '<path d="M2 12c2-3 4-3 6 0s4 3 6 0 4-3 6 0"/><path d="M2 18c2-3 4-3 6 0s4 3 6 0 4-3 6 0"/><path d="M2 6c2-3 4-3 6 0s4 3 6 0 4-3 6 0"/>'
  ),
  heart: _i(
  ...
  house: _i(
    '<path d="M3 9.5L12 3l9 6.5V20a1 1 0 01-1 1H4a1 1 0 01-1-1V9.5z"/><rect x="9" y="14" width="6" height="7"/>'
  ),
  ...
  apple: _i(
    '<path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/><line x1="12" y1="2" x2="12" y2="5"/>'
  ),
  ...
  dumbbell: _i(
    '<path d="M6.5 6.5h11v11h-11z" fill="none"/><line x1="2" y1="12" x2="6" y2="12"/><line x1="18" y1="12" x2="22" y2="12"/><rect x="6" y="7" width="3" height="10" rx="1"/><rect x="15" y="7" width="3" height="10" rx="1"/>'
  ),
  ...
  palette: _i(
    '<circle cx="13.5" cy="6.5" r="1.5"/><circle cx="17.5" cy="10.5" r="1.5"/><circle cx="8.5" cy="7.5" r="1.5"/><circle cx="6.5" cy="12" r="1.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.93 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.04-.23-.29-.38-.63-.38-1.02 0-.83.67-1.5 1.5-1.5H16c3.31 0 6-2.69 6-6 0-5.5-4.5-9.94-10-9.94z"/>'
  ),
  key: _i(
  ...
  car: _i(
    '<path d="M16 3H1v10h16V3z" fill="none"/><circle cx="5.5" cy="13.5" r="2.5"/><circle cx="12.5" cy="13.5" r="2.5"/><path d="M4 3l-3 7h18l-3-7"/>'
  ),
  film: _i(
  ...
  flower: _i(
    '<path d="M12 7.5a4.5 4.5 0 11-4.5 4.5M12 7.5a4.5 4.5 0 104.5 4.5M12 7.5V3"/><circle cx="12" cy="12" r="3"/><path d="M12 16.5V21"/>'
  ),
  brain: _i(
...
const PAGE_META = {
  ...
  together: { icon: _IC.heart, label: 'Together' },
  connect: { icon: _IC.mail, label: 'Letters' },
  games: { icon: _IC.game, label: 'Play' },
  datenight: { icon: _IC.moon, label: 'Date Night' },
  checkin: { icon: _IC.barChart, label: 'Check-in' },
  knowyou: { icon: _IC.users, label: 'Know You' },
  wellness: { icon: _IC.activity, label: 'Wellness' },
  mood: { icon: _IC.sun, label: 'Mood' },
  fitness: { icon: _IC.dumbbell, label: 'Fitness' },
  nutrition: { icon: _IC.apple, label: 'Nutrition' },
  gratitude: { icon: _IC.star, label: 'Gratitude' },
  plan: { icon: _IC.globe, label: 'Plan' },
  dreams: { icon: _IC.sparkle, label: 'Dreams' },
  dreamhome: { icon: _IC.house, label: 'Dream Home' },
  homelife: { icon: _IC.dollar, label: 'Finances' },
  ...
  w1: { icon: _IC.dumbbell, label: 'Foundation' },
  w2: { icon: _IC.dumbbell, label: 'Elevated' },
  w3: { icon: _IC.dumbbell, label: 'Full Body' }
};
...
function initSwipeNav() {
  ...
  shell.addEventListener(
    ...
    function (e) {
      ...
      _swipeOnInteractive =
        tag === 'INPUT' || tag === 'TEXTAREA' || tag === 'BUTTON' || tag === 'SELECT' || e.target.closest('.pill-row');
    },
    { passive: true }
  );
...
function setGlobalMode(mode) {
  ...
  if (pill)
    pill.querySelectorAll('.gmp-opt').forEach(o => {
...
function replaceEmojisWithIcons() {
  ...
  document
    .querySelectorAll('.hub-row, .hub-feature-card, .explore-quick-item, .explore-spot-card')
    .forEach(function (el) {
